...
func (c *MockChainClient) GetBlockHeight() (int64, error) {
	return 0, nil
}

func (c *MockChainClient) AsyncBroadcastMsgWithOpts(opts *TXStatus, msgs ...sdk.Msg) (*txtypes.BroadcastTxResponse, error) {
	return &txtypes.BroadcastTxResponse{}, nil
}

func (c *MockChainClient) AdjustGasPricesToMax() {}

func (c *MockChainClient) AdjustedGasPricesToOrigin() {}

func (c *MockChainClient) SetSimulate(simulate bool, gasWanted uint64) {}

func (c *MockChainClient) GetGasWanted() uint64 {
	return 0
}
